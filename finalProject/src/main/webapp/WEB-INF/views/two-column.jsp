                        ...
                        <div class="sub-banner-inner-con padding-bottom">
                            ...
                            <div class="breadcrumb-con d-inline-block" data-aos="fade-up" data-aos-duration="600">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Two Column</li>
                                </ol>
                            </div>
                            ...
                            <div class="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div class="post-item-wrap position-relative">
                                    <div class="post-image">
                                        <a href="single-blog">
                                            <img alt="image" src="assets/images/post-featured.jpg" loading="lazy">
                                        </a>
                                    </div>
                                    ...
                                    <div id="blogslider" class="carousel slide" data-ride="carousel">
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <img src="assets/images/post-featured2.jpg" alt="image" loading="lazy">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="assets/images/post-featured4.jpg" alt="image" loading="lazy">
                                            </div>
                                            <div class="carousel-item">
                                                <img src="assets/images/post-featured3.jpg" alt="image" loading="lazy">
                                            </div>
                                        </div>
                                ...
                                <div class="post-item-wrap position-relative">
                                    <div class="post-image">
                                        <a href="single-blog"><img alt="image"
                                                src="assets/images/post-featured4.jpg" loading="lazy"></a>
                                    </div>
                                    <div class="lower-portion">
                                        <div class="span-i-con">
                                            <i class="fa-solid fa-user"></i>
                            ...
                            <div class="blog-box twocolumn-blog float-left w-100 post-item mb-4">
                                <div class="post-item-wrap position-relative">
                                    <div class="post-audio position-relative">
                                        <a href="single-blog"><img alt="image"
                                                src="assets/images/post-featured3.jpg" loading="lazy"></a>
