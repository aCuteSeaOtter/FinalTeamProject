      ...
      <div class="col-sm-12">
        ...
        <div id="user_chat_data" class="user_chat_data">
          <div class="profile_name">
            &nbsp;&nbsp;&nbsp;&nbsp;<img src="/images/profile.png" class="mr-3 rounded-circle"> &nbsp;&nbsp; 
            <span id="username"><%= username %></span><span id="roomNum"></span>
          </div>
          ...
          <div class="type_msg">
		    <div class="input_msg_write">
		        <input id="msg-box" type="text" class="write_msg" placeholder="메시지를 입력하세요." autocomplete="off" />
