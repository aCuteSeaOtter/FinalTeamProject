...
<!--					<div class="col-6">12
					  <div class="form-group">
						...
						<br/>
						<select name="year" 	id="year" style="width:100px; height:70px;" required></select>년
						<select name="month"	id="month"style="width:100px; height:70px;"	required></select>월
						<select name="day"	id="day"  style="width:100px; height:70px;"required></select>일
					  </div>
					</div>
