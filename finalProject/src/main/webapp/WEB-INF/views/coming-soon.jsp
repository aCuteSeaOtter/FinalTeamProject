...
<head>
  <title>Travel | Coming Soon </title>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="comingsoon_outer d-flex flex-column">
    <!-- Sub Banner -->
    <section
      class="coming-soon-con position-relative float-left w-100 padding-top padding-bottom main-box text-center d-flex flex-column justify-content-center">
        ...
        <div class="row">
          <div class="col-12">
            <div class="logo-wrapper">
              <a href="index">
                <figure class="banner-logo mb-0 d-inline-block">
                  <img src="/assets/images/logo-icon.png" alt="logo-icon" class="img-fluid">
                </figure>
              </a>
              <!-- logo wrapper -->
            </div>
            <div class="coming-banner-content">
              <h4 class="text-uppercase">we are coming soon</h4>
              <h1>Get Notified when <br>
                Site Goes live.</h1>
              <p>Lorem ipsum dolor sit amet consectetur adipiscing elit sed doeiusm <br> tempor incididunt ut labore et
                dolore.</p>
    ...
    <div class="container">
      <div class="coming-soon-copyright text-center d-flex justify-content-center align-items-center">
        <p class="mb-0">Copyright ©2024 TravelTrek.com All Rights Reserved</p>
