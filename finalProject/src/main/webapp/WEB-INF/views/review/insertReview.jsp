						...
						<div class="table-responsive">
	                        <table border="1">
	                            ...
	                            <tr id="starRow">
	                                ...
	                                <td>
	                                    <fieldset>
	                                        <input type="radio" name="review_star" class="star" value="5" id="rate1"><label for="rate1">★</label>
	                                        <input type="radio" name="review_star" class="star" value="4" id="rate2"><label for="rate2">★</label>
	                                        <input type="radio" name="review_star" class="star" value="3" id="rate3"><label for="rate3">★</label>
	                                        <input type="radio" name="review_star" class="star" value="2" id="rate4"><label for="rate4">★</label>
	                                        <input type="radio" name="review_star" class="star" value="1" id="rate5"><label for="rate5">★</label>
	                                    </fieldset>
	                                </td>
	                            </tr>
	                            <tr>
