                        ...
                        <div class="sub-banner-inner-con padding-bottom">
                            ...
                            <div class="breadcrumb-con d-inline-block" data-aos="fade-up" data-aos-duration="600">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">One Column</li>
                                </ol>
                            </div>
            ...
            <div class="row wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                <div id="blog" class="col-xl-12">
                    ...
                    <div class="blog-box onecolumn-blog float-left w-100 post-item mb-4">
                        <div class="post-item-wrap position-relative">
                            <div class="post-image">
                                <a href="single-blog"><img alt="image" src="assets/images/post-featured4.jpg"
                                        loading="lazy"></a>
                            </div>
                            <div class="lower-portion">
                                <div class="span-i-con">
                    ...
                    <div class="blog-box onecolumn-blog float-left w-100 post-item mb-0">
                        <div class="post-item-wrap position-relative">
                            <div class="post-video">
