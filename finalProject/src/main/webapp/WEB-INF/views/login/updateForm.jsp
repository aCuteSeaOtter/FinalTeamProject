                  ...
                  <div class="row">
					...
					<div class="col-6"><!--12-->
					  <div class="form-group">
						...
						<br/>
						<select name="memberbirth" 	id="year" style="width:100px; height:70px;" required></select>년
						<select name="memberbirth"	id="month"style="width:100px; height:70px;"	required></select>월
						<select name="memberbirth"	id="day"  style="width:100px; height:70px;"required></select>일
					  </div>
					</div>
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="form-group mb-0">
						...
						<input type="checkbox" style="width:20px; height:20px;"name="memberagree" value="확인" required>
						<br/> 
