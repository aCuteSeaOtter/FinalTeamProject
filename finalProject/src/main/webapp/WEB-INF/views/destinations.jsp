...
<body>
  ...
  <section class="float-left w-100 top-destinations-con  position-relative padding-top padding-bottom main-box">
    ...
    <div class="container destination-con2 wow bounceInUp" data-wow-duration="2s">
      ...
      <div class="owl-carousel">
        <div class="item">
          ...
          <div class="destination-box position-relative">
            <div class="orange-tag position-absolute">$350</div>
            <figure><img src="/assets/images/destination-img4.jpg" alt="image" class="img-fluid"></figure>
            <div class="bottom-con">
              <span class="d-block text-uppercase">
                Island, New Zealand
              </span>
        ...
        <div class="item">
          <div class="destination-box position-relative">
            <div class="orange-tag position-absolute">$355</div>
          ...
          <div class="destination-box position-relative">
            ...
            <figure><img src="/assets/images/destination-img5.jpg" alt="image" class="img-fluid"></figure>
            <div class="bottom-con">
              <span class="d-block text-uppercase">
                National Park, USA
              </span>
        ...
        <div class="item">
          <div class="destination-box position-relative">
            <div class="orange-tag position-absolute">$579</div>
          ...
          <div class="destination-box position-relative">
            <div class="orange-tag position-absolute">$450</div>
            <figure><img src="/assets/images/destination-img6.jpg" alt="image" class="img-fluid"></figure>
            <div class="bottom-con">
              <span class="d-block text-uppercase">
                New York, NY
              </span>
  ...
  <section class="float-left w-100 travel-tour-con position-relative">
    <div class="color-overlay position-relative padding-top padding-bottom main-box">
      <div class="container wow bounceInUp" data-wow-duration="2s">
        ...
        <ul class="nav nav-tabs text-center align-items-center justify-content-center" id="myTab" role="tablist">
