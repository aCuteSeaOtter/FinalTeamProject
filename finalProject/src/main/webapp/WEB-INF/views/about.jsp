...
<body>
  ...
  <section class="float-left w-100 exploring-activites-con position-relative main-box padding-top">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="heading-title text-center">
            <h4 class="text-uppercase">Explore Activities</h4>
            <h2 class="">Making Adventure Tours, <br>
              ...
              <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                  <div class="video_icon position-relative">
                    <a class="popup-vimeo"
                      href="https://previews.customer.envatousercontent.com/h264-video-previews/18e20497-1649-4361-9498-aaad11e836c5/51157855.mp4">
                      <div class="video_wrapper">
                        <figure class="mb-0">
                          <img class="thumb img-fluid text-center" style="cursor: pointer"
                            src=".//assets/images/video-icon.png" alt="video-icon">
                        </figure>
                        <div class="centered">
                          <h4 class="text-white mb-0">Discover the Adventure</h6>
                            <!--centered-->
                        </div>
                        <!-- video wrapper -->
                      </div>
  ...
  <section
    class="float-left w-100 what-we-serve-con meet-our-team-con position-relative main-box padding-top padding-bottom">
    ...
    <div class="container wow bounceInUp" data-wow-duration="2s">
      <div class="row">
        <div class="col-lg-6">
          <h4 class="mustard-text text-uppercase">Professional people</h4>
          <h2 class="text-uppercase text-right">meet our tour <br>
            guides</h2>
        </div>
        <div class="col-xl-10 col-12 mr-auto ml-auto serve-outer text-center">
          <div class="server-box var1">
            ...
            <ul class="d-inline-block list-unstyled p-0 m-0">
              ...
              <li class="d-inline-block"><a href="https://twitter.com/i/flow/login"><i
                    class="fa-brands fa-x-twitter"></i></a></li>
              <li class="d-inline-block"><a href="https://www.instagram.com/" class="mr-0"><i
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-8 col-md-8 order-xl-0 order-lg-0 order-md-0 order-1">
          <div class="plan-trip-sub-con">
            <div class="heading-content text-left position-relative">
              <h4 class="text-uppercase">Plan your trip with us</h4>
              <h2 class="text-uppercase">Ready for An <br>
                Unforgetable Tour?
              </h2>
              <div class="green-btn d-inline-block">
        ...
        <div class="col-lg-4 col-md-4">
          <figure><img class="img-fluid" src="/assets/images/plan-trip-img.png" alt="image"></figure>
          <!-- col -->
        </div>
        <!-- row -->
      </div>
