                        ...
                        <div class="single-blog-outer-con">
                            <div class="single-blog-box">
                                ...
                                <div class="single-blog-details">
                                    ...
                                    <h4><a href="single-blog">Our strength, Your Business</a></h4>
                            ...
                            <div class="single-blog-box">
                                ...
                                <div class="single-blog-details">
                                    ...
                                    <h4><a href="single-blog">How’s the Economy?</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod. Lorem
                                        ipsum dolor sit amet, consectetur</p>
                                    <div class="generic-btn2">
                                        <a href="single-blog">READ MORE</a>
                    ...
                    <nav aria-label="...">
                        <ul class="pagination">
                            <li class="page-item disabled">
                                <a class="page-link" href="single-blog" tabindex="-1"><i
                                        class="fas fa-angle-left"></i></a>
                            </li>
                            <li class="page-item"><a class="page-link" href="one-column">1</a></li>
                            <li class="page-item active">
                                <a class="page-link" href="two-column">2 <span class="sr-only">(current)</span></a>
                            </li>
                            <li class="page-item"><a class="page-link" href="three-column">3</a></li>
                            <li class="page-item"><a class="page-link" href="four-column">4</a></li>
                            <li class="page-item"><a class="page-link" href="three-colum-sidbar">5</a></li>
                            <li class="page-item"><a class="page-link" href="six-colum-full-wide">6</a></li>
                            <li class="page-item"><a class="page-link" href="load-more">7</a></li>
                            <li class="page-item"><a class="page-link" href="single-blog">8</a></li>
                            <li class="page-item">
                                <a class="page-link" href="single-blog"><i class="fas fa-angle-right"></i></a>
                            </li>
                        </ul>
                    </nav>
                </div>
