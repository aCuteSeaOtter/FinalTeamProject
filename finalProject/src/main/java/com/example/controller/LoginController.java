...
//	
    ...
    @GetMapping("/login/oauth2/code/kakao") // GET 요청을 처리하는 URL
	...
	public String savecontact(@Valid  LoginVO member2VO, BindingResult bindingResult) {
		if(bindingResult.hasErrors()) {
			return "contact";
		}
			
		System.out.println(member2VO);
		loginService.savecontact(member2VO);
