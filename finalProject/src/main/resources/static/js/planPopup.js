$(function() {
    ...
    // selectedAttrIdDataMap 초기화
    let storedData = localStorage.getItem('popupData' + day);
    selectedAttrIdDataMap[day] = storedData ? storedData : [];
    ...
    $(document).on('click', '.deleteItem', function() {
		...
		opener.console.log("'popupData'+day :" + localStorage.getItem('popupData'+day));
	...
	function loadSelectedAttractions() {
	    let storedData = localStorage.getItem('popupData' + day);
	    let selectedAttrIds = storedData ? storedData : [];

	    selectedAttrIdDataMap[day] = selectedAttrIds;
	...
	function highlightSelectedAttractions() {
		...
		opener.console.log(selectedAttrIds);
	...
	function renderAttractions(attractions) {
		...
		// 이벤트 재바인딩
	    $(".selectBox").off("click").on("click", function() {
	        const currentSrc = $(this).attr('src');
	        var divBlock = $(this).closest('.divBlock');
	        var selectedItem = $('.selectedScrollBox').find('.selectedItem');
	        var exists = false;
	        ...
	        if (currentSrc.includes('/images/plan/none_select.svg')) {
	            ...
	            // 배열에 선택된 명소 id 저장
				selectedAttrIdDataMap[day].push(selectedAttrId);
				opener.console.log(selectedAttrIdDataMap[day]);
				updateLocalStorage();
